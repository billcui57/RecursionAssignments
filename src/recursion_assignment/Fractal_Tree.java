 ...
 * @author billc
 */
public class Fractal_Tree extends javax.swing.JPanel {

    /**
     * Creates new form Fractal_Tree
     */
    public Fractal_Tree() {
        initComponents();
    }
    ...
    public void paintComponent(Graphics g) {
        treeFractal(g,5,this.getWidth()/2,this.getHeight()/2,100,20);
    }
